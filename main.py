...
async def migrate_database():
    """Run database migration for registration tracking fields"""
    if not SessionLocal:
    ...
    try:
        ...
        existing_columns = [row[0] for row in db.execute(check_columns)]
        migration_results.append(f"Existing tracking columns: {existing_columns}")
        ...
        if 'account_setup_action' not in existing_columns:
            ...
            """))
            migration_results.append("✅ account_setup_action column added")
        else:
            migration_results.append("⏭️ account_setup_action column already exists")
        ...
        if 'account_setup_completed_at' not in existing_columns:
            ...
            """))
            migration_results.append("✅ account_setup_completed_at column added")
        else:
            migration_results.append("⏭️ account_setup_completed_at column already exists")
        ...
        if 'step_completed' not in existing_columns:
            ...
            """))
            migration_results.append("✅ step_completed column added")
        else:
            migration_results.append("⏭️ step_completed column already exists")
        ...
        migration_results.append(f"✅ Updated {updated_count} existing records to step_completed = 2")
